export const JP = {
    ...
    PolicyOilWellPowerx2Desc: "油井の消費電力と原油生産量が2倍になります",
    ...
    SuperSteelMillDesc: "製鋼所の石炭消費が50%減り、鉄と電気の消費が25%増えます",
    AlSemiconductor: "Al半導体",
    AlSemiconductorDesc: "半導体工場が銅の代わりにアルミを使用するようになります",
    CostSaver: "コストセーバー",
    ...
    GasPlantPetrol: "ガス液化",
    GasPlantPetrolDesc: "ガス発電所で追加のガスを消費してガソリンを生産します",
    BuildingRecycle: "建築リサイクル",
    BuildingRecycleDesc: "施設を建てたたあと1分以内に売ると全額返金されます",
    CoalPlantFuel: "石炭液化",
    CoalPlantFuelDesc: "石炭発電所で、追加の石炭を使用してガソリンを生産します",
    Welcome: "Welcome",
    ...
    Tips9: "施設のアンロックに必要な研究ポイントは、資源の市場価格によって決まります",
    ...
    SwissBank: "スイス銀行",
    SwissMoney: "%{money}💵",
    PrestigeDesc: "新しい街で始めると、%{money}がもらえます💵",
    ...
    BuildingPermitCostDivider: "建築許可証割引率",
    ...
    PrestigeCurrencyDesc: "これはスイス銀行の口座にあるお金で、新しい街で始めるときに持っていくことができます",
    Prestige: "Cash In",
    Cancel: "キャンセル",
    ...
    ResourceExplorerDescLong: "💡資源探査機には隣接ボーナスがありません。電力使用量は資源ごとに異なります",
    ResourceExplorerSelectResource: "エクスペリエンス",
    ...
    SocialNetwork: "SNSサービス",
    DatabaseCompany: "データベースメーカー",
    Database: "データベース",
    SatelinkInc: "株式会社サテライトリンク",
    GameStationInc: "ゲームステーション社",
    AirShuttleInc: "宇宙船メーカー",
    AircraftCarrierFactory: "空母工場",
    AircraftCarrier: "空母",
    MapExclusive: "現在のマップタイプ専用",
    ElectricCar: "ニコラ・テスラ",
    ElectricCarDesc: "自動車工場がガソリンの代わりにバッテリーを使用し、必要な量は50%で済みます",
    HongKongBonusV2:
    ...
    BuildWarningTitle: "ビルディングはうまくいかないかもしれない",
    BuildWarningTitleDesc: "%{reason}をこのタイルに設置しますか？",
    BuildWarningBuildAnyway: "とりあえず建てる",
    ...
    ResourceBoosterSquareDesc: "リソースブースターのブースト量が25%増加。ただし科学と電力の消費量も25%増加",
    SteelMillx2: "鉄鋼炉の近代化",
    SteelMillx2Desc: "製鋼所とステンレス合金プラントの入出力が2倍になる。ただし消費電力も2倍になる",
    ...
    GasPumpx2OutputDesc: "天然ガスポンプの出力が2倍になるが、消費電力も2倍になる",
    ...
    ExtraPolicyPointsDescV2: "ポリシーセンターのポリシーポイント変換能力が2倍",
    PowerRequired: "必要な電力",
    ...
    PledgeAmount: "%{amount}の資源を提供",
    PledgeValue: "現金$%{amount}相当",
    ...
    ResourceBoosterBannerDescV2:
        "💡 現在、%{number}個のリソースブースターを持っています - それぞれの科学入力は、現在持っているリソースブースターの数に比例します",
};
