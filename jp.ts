export const JP = {
    ...
    OfflineEarningMultiplier: "オフライン収入倍率",
    OfflineEarningMultiplierDesc: "オフライン収入に適用される倍率",
    ...
    SanJose: "サンノゼ",
    SanJoseBonus:
        "<li>ユニーク施設 : チップメーカー</li><li>ユニーク施設 : FaceApp Inc</li><li>ユニーク施設 : ビットコイン・マイナー</li><li>シリコンを消費する全ての施設が最大のタイル補正を受ける</li><li>ソーラーパネルの発電量が2倍</li><li>シリコン鉱山の生産量が2倍</li>",
    RotterdamBonusV2:
    ...
    ReturnOnPledgeDescV2:
        "トータルリターンは、誓約金額の合計に、すべてのリソースのリターン率を掛けたものになります。リソースの支援者が多ければ、そのリターンは向上します",
    PlayerTradeQuotaDescV2:
        "💡クォータとは、あなたが取引できるリソースの量のことです。割当量は、マーケットキャップの%{percent}に相当し、マーケットが更新されるとリセットされます。トレードの価格がトレードセンターの価格から乖離するほど、より多くのクォータが必要になります",
